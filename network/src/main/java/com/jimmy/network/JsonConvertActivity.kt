...
class JsonConvertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_origin_json.setOnClickListener {
            tv_json.text = "json串内容如下：\n$json"
